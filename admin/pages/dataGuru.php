...
$dataUser = $confg->query("SELECT * FROM tbl_guru");
...
<head>
    ...
    <title>APP KESISWAAN - DATA GURU</title>
</head>
        ...
        <div class="w-full h-[4rem] m-6 p-4 rounded-lg relative bg-slate-800 text-zinc-300">
                ...
                <?php 
                    ...
                    ?>
                        ...
                        </svg><span class='font-bold'>&nbspSUCCESS HAPUS DATA &nbsp</span>Anda Akan Telah menghapus Data Guru!! 
                        </div>
                    <?php
                    }else{
                    ?>  
                        ...
                        <span class='font-bold'>&nbspGAGAL HAPUS DATA&nbsp</span> Anda GAGAL menghapus Data Guru!! 
                        </div>
                    <?php
                    }
                }
                    ...
                    >
                        ...
                        ?>
                            <tr class="text-center dt-control">
                                <td class="px-6 py-4 dark:bg-gray-800 font-medium "><?=$row['id_guru']?></td>

...
<div class="md:flex md:flex-row">
        ...
        <div class="bg-slate-800 w-72 text-purple-600 font-mono focus:outline-none z-20 px-6 py-9 absolute inset-y-0 left-0 transform -translate-x-full transition duration-500 ease-in-out lg:relative lg:translate-x-0" id="sidebar">
            ...
            <div class="w-full h-[4rem] m-6 p-4 rounded-lg bg-slate-800 text-zinc-300">
                ...
                <div class="py-3">
                <button type="button"type="submit" onclick="window.location.href= 'tambahListPelajaran'" class="flex items-center uppercase gap-2 font-medium text-white rounded-md p-2 bg-indigo-500 focus:outline-none hover:shadow-lg shadow-indigo-300/100"><img src="../../icons/plus.png"class="h-5 w-5">TAMBAH DAFTAR PELAJARAN</button>
                </div>
                <div class="relative overflow-x-auto shadow-md bg-slate-800 rounded-lg text-gray-400 pt-7">
                    ...
                    ?>
                        ...
                        </svg><span class='font-bold'>&nbspSUCCESS HAPUS DATA &nbsp</span>Anda Akan Telah menghapus Data Daftar Pelajaran!! 
                        </div>
                    <?php
                    }else{
                    ?>  
                        ...
                        <span class='font-bold'>&nbspGAGAL HAPUS DATA&nbsp</span> Anda GAGAL menghapus Data Daftar Pelajaran!! 
                        </div>
                    <?php
                    }
                }

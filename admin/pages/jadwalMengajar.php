...
$tbl_daftar_pelajaran = $confg->query("SELECT * FROM tbl_pelajaran");
...
<head>
    ...
    <title>APP KESISWAAN - LIST PELAJARAN</title>
</head>
...
<div class="md:flex md:flex-row">
        ...
        <div class="bg-slate-800 w-72 text-purple-600 font-mono focus:outline-none z-20 px-6 py-9 absolute inset-y-0 left-0 transform -translate-x-full transition duration-500 ease-in-out lg:relative lg:translate-x-0" id="sidebar">
            ...
            <div class="w-full h-[4rem] m-6 p-4 rounded-lg bg-slate-800 text-zinc-300">
                ...
                <div class="py-3">
                <button type="button"type="submit" onclick="window.location.href= 'tambahJadwalMengajar'" class="flex items-center uppercase gap-2 font-medium text-white rounded-md p-2 py-2 bg-indigo-500 focus:outline-none hover:shadow-lg shadow-indigo-300/100"><img src="../../icons/plus.png"class="h-5 w-5">Tambah Jadwal Mengajar</button>
                </div>
                ...
                ?>
                    ...
                    >
                        ...
                        <tbody>
                        <?php
                        while($row = mysqli_fetch_array($tbl_daftar_pelajaran)){
                        ?>
                            <tr class="text-center">
                                <td class="px-6 py-4 dark:bg-gray-800 font-medium "><?=$row['id']?></td>
                                <td class="px-6 py-4 dark:bg-gray-800 font-medium text-blue-600"><?=$row['mata_pelajaran']?></td>
                                <td class="px-6 py-4 dark:bg-gray-800 font-medium text-blue-600"><?=$row['pengajar']?></td>
                                <td class="px-6 py-4 dark:bg-gray-800 font-medium"><?=$row['kelas_mengajar']?></td>
                                ...
                                <div class="flex flex-wrap">
                                    <td class="py-4 text-base font-medium uppercase dark:bg-gray-800 cursor-pointer ">
                                        <a href="jadwalMengajar-edit?id=<?= uniqid($row['id']) ?>"class="p-2 px-2 bg-blue-dark text-indigo-500">
                                            <span>Edit</span>
                                        </a>
                                    <div class="py-4">
                                        <a href="jadwalMengajar-delete?id=<?= uniqid($row['id']) ?>"onclick="return confirm('Yakin Anda Ingin Menghapus')"class="p-2 px-2 bg-red-700 text-slate-400">
                                            <span>Hapus</span>
                                        </a>
                                    </div>
                                    </td>

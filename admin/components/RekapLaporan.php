...
<head>
    ...
    <title>APP KESISWAAN - REKAPITULASI LAPORAN</title>
</head>
                        ...
                        <tr class="text-center">
                            ...
                            <div class="flex flex-wrap">
                                    <td class="py-4 text-base font-medium uppercase dark:bg-gray-800 cursor-pointer ">
                                        <a href="RekapLaporan-edit?id=<?= uniqid($row['id']) ?>"class="p-2 px-2 bg-blue-dark text-indigo-500">
                                            <span>Edit</span>
                                        </a>
                                    <div class="py-4">
                                        <a href="RekapLaporan-delete?id=<?= uniqid($row['id']) ?>"onclick="return confirm('Yakin Anda Ingin Menghapus')"class="p-2 px-2 bg-red-700 text-slate-400">
                                            <span>Hapus</span>
                                        </a>
                                    </div>
                                    </td>
